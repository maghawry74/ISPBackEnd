...
namespace ISPBackEnd.Tests.Controller
{
    public class GovernaratesControllerTest
    {
        ...
        public async Task GovernaratesController_GetGovernarates_ReturnsOk()
        {
            ...
            {
                      new ReadGovernarateDTO { Code = 1, Name = "Governarate 1", Status = true },
                      new ReadGovernarateDTO { Code = 2, Name = "Governarate 2", Status = true },
                      new ReadGovernarateDTO { Code = 3, Name = "Governarate 3", Status = false }
            };
